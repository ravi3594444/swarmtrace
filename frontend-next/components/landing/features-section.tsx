...
const features = [
  {
    ...
    description: "Every function call your agent makes is captured automatically with @observe. Zero config, full visibility.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "Cost Analytics",
    description: "Track token usage and cost per agent, per function, per run. Know exactly where your budget is going.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Multi-Agent Support",
    description: "Built for swarms. Parent-child trace relationships show you exactly how agents collaborate and where they fail.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Regression Detection",
    description: "Catch when your agents start behaving differently. Automatic comparison against baseline runs.",
    visual: "security",
  },
];
