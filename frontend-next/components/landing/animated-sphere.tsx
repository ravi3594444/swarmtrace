...
export function AnimatedSphere() {
  ...
  // Cache the theme color in a ref so we're not doing a DOM read on every frame
  // Updated immediately via MutationObserver whenever the .dark class toggles
  ...
  useEffect(() => {
    ...
    const observer = new MutationObserver(() => {
      themeColorRef.current = document.documentElement.classList.contains("dark")
        ? "255,255,255"
        : "0,0,0";
    });
