...
import { ChevronRight, ChevronDown, Copy, Check, ChevronsDownUp, ChevronsUpDown, GitBranch } from "lucide-react";
    ...
    <div className="rounded-xl border border-border bg-card overflow-hidden">
      <div className="flex items-center justify-between border-b border-border bg-muted/40 px-4 py-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="font-mono text-[11px] text-muted-foreground uppercase tracking-wider ml-1">execution sequence</span>
        </div>
      </div>
      <div>
        {roots.length === 0 ? (
