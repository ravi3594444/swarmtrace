"""
Swarm Module 0 - Trace Simulation
...
class SwarmTraceSimulator0:
    """Swarm trace simulator class 0"""
...
simulator = SwarmTraceSimulator0()

# Update and print trace
for _ in range(10):
    simulator.update()
    trace = simulator.get_trace()
    print(f'Module 0 - Iteration {trace["iteration"]}: {len(trace["agents"])} agents')
    time.sleep(0.1)
