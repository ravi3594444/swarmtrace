"""
Swarm Module 2 - Trace Simulation
...
class SwarmTraceSimulator2:
    """Swarm trace simulator class 2"""
...
simulator = SwarmTraceSimulator2()

# Update and print trace
for _ in range(10):
    simulator.update()
    trace = simulator.get_trace()
    print(f'Module 2 - Iteration {trace["iteration"]}: {len(trace["agents"])} agents')
    time.sleep(0.1)
