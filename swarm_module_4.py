"""
Swarm Module 4 - Trace Simulation
...
class SwarmTraceSimulator4:
    """Swarm trace simulator class 4"""
...
simulator = SwarmTraceSimulator4()

# Update and print trace
for _ in range(10):
    simulator.update()
    trace = simulator.get_trace()
    print(f'Module 4 - Iteration {trace["iteration"]}: {len(trace["agents"])} agents')
    time.sleep(0.1)
